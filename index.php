...
?><div id="telo"><?php
    ...
    ?><div id="obsah"><?php
            ...
            ?></div><?php
            ?><div id="paticka"><?php
                ?><a href="mailto:<?php echo MAIL?>">&copy;&nbsp; 2019 - 2021 &nbsp;<?php echo TITLE?></a><?php
            ?></div><?php
        ?></div><?php
    ?></div><?php
    ?></div><?php
...
function vypis_menu($struktura,$actual){
    ...
    foreach($struktura as $k => $v):
        ?><li><?php
            ?><a href="./index.php<?php if($k!="uvod"):?>?pg=<?php echo $k?><?php endif;?>"<?php if($k==$actual):?> class="actual"<?php endif;?>><?php echo $v[menu]?></a><?php
